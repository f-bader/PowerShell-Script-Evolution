...
# Usage: .\2_Inital_Get-FreeIpAddresses.ps1 -NetworkName GlobalAzureBootcamp2019-vnet
# Usage: .\2_Inital_Get-FreeIpAddresses.ps1 -NetworkName GlobalAzureBootcamp2019-vnet -ResourceGroupName GlobalAzureBootcamp2019
